...
<div class="container" style="margin-top: 20px;">
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="card">
                <div class="card-header">Edit visa problem</div>
                <div class="card-body">
                    <form action="{{route('problemUpdate', ['id'=>$edits->id])}}" method="post"
                        ...
                        <div class="form-group">
                            <label for="branImage">Visa problem Image</label>
                        ...
                        <div class="form-group">
                            <img src="{{asset('images/visaProblem')}}/{{$edits->image}}"
                                style="height: 200px; width:400px;" alt="">
                        </div>
                    </div>
                        <button type="submit" class="btn btn-primary">Update Visa Problem</button>
                    </form>
                </div>
            </div>
        </div>
