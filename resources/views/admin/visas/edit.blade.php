...
<div class="container" style="margin-top: 20px;">
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="card">
                <div class="card-header">Edit Visa</div>
                <div class="card-body">
                    <form action="{{route('visaUpdate', ['id'=>$edits->id])}}" method="post"
                        ...
                        <div class="form-group">
                            <label for="brandName">Box Number</label>
                            <input type="text" name="box" class="form-control" id="exampleInputEmail1"
                                aria-describedby="emailHelp" value="{{$edits->boxnumber}}">
                            @error('box')
                        ...
                        <div class="form-group">
                            <label for="branImage">Visa Image</label>
                        ...
                        <div class="form-group">
                            <img src="{{asset('images/visas')}}/{{$edits->image}}"
